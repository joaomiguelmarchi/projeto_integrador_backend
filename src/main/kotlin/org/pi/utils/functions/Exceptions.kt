...
val PATIENT_ID_IS_EMPTY = DefaultError("PATIENT_ID_IS_EMPTY", "Paciente deve ser informado")
val PATIENT_NOT_FOUND = DefaultError("PATIENT_NOT_FOUND", "Paciente nao encontrado")
